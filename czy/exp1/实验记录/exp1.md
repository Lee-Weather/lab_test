...
| exp2.4 | 2026-08-03 | 修复:左右腿default_pos镜像对称(FK验证dx=0 dz=0)，重训3001 iter | 训练中 | TASK_20260803_064 | yijed24226@barumart.com | - |
...
> 训练任务：TASK_20260803_064（yijed24226 账号，代码 e4e9756）
> 第一次尝试 TASK_20260803_059（peleha7269）在 iter 221 异常终止（status 6，平台问题，无错误日志），peleha7269 账户余额耗尽。

#### 执行日志

| 时间 | 事件 |
|------|------|
| 2026-08-03 11:39 | 创建并启动 TASK_20260803_059（peleha7269 账号，3001 iter） |
| 2026-08-03 11:48 | 训练开始（iter 0），正常推进 |
| 2026-08-03 12:00 | **异常终止**（status 6），iter 221/3001，无错误日志。GM 已上传 model_0/100/200.pt |
| 2026-08-03 12:35 | peleha7269 账户余额不足，无法重新运行 |
| 2026-08-03 12:36 | 创建并启动 TASK_20260803_064（yijed24226 账号，相同配置，ETA ~14:55） |
| - | 待训练完成 |
